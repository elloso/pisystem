...
class RPCPPEpdf_Controller  extends CI_Controller
{
    public function RPCPPEform()
    {
        ...
        $rpcppedata = $this->Fpdf_Model->rpcppe_data($PropertyName,$YearSelected);
        ...
        foreach($rpcppedata as $data){
            ...
            $pdf->multicell(20, 7, $data->onhand_percount, '', 'C');
            $pdf->SetXY($x + 180, $y + 10 ); 
            $pdf->multicell(15, 7, ($data->quantity-$data->onhand_percount), '', 'C');
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 6, 'REPORT ON THE PHYSICAL COUNT OF PROPERTY, PLANT AND EQUIPMENT', 0, 1, 'C');
