...
class PTRPARpdf_Controller extends CI_Controller
{
    public function PTRPARform($po_id,$id_tblpo_item)
    {

        $actual_po_id = $po_id;
        $actual_icsrsepi_po_id = $id_tblpo_item;
        $rsepi_data = $this->Fpdf_Model->DataRSEPIPAR_PTR($po_id,$actual_icsrsepi_po_id);
        ...
        $pdf->SetFont('times', '', 10);
        $pdf->Cell(45, 8, $rsepi_data->par_fund, 'B', 1, 'L');
        ...
        $pdf->SetXY($x+65, $y);
        $pdf->Cell(50, 6, $rsepi_data->par_receivedby, 'B', 1, 'L');
        $pdf->SetXY($x+110, $y);
        $pdf->Cell(11, 6, '', '', 1, 'L');
        $pdf->SetXY($x+120, $y);
        ...
        $pdf->SetXY($x+50, $y+37);
        $pdf->Cell(25, 10, $rsepi_data->par_no, '', 0, 'C');
        $pdf->SetXY($x+75, $y+37);
