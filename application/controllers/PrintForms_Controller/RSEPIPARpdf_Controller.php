...
class RSEPIPARpdf_Controller extends CI_Controller
{
    public function RSEPIPARform()
    {
        ...
        $Datas = $this->Fpdf_Model->DataRSEPIPAR();
        $pdf = new PDF();
            $pdf->AddPage();
            ...
            foreach ($Datas as $Data) {
                ...
                $pdf->SetXY($x + 15, $y + 9); 
                $pdf->Cell(18, 5, $Data->par_no, 'RB', 0, 'C'); // Use Cell instead of MultiCell
                ...
                $pdf->SetXY($x + 133, $y + 9); 
                $pdf->Cell(22, 5, $Data->par_receivedby, 'BR', 0, 'C'); // Use Cell instead of MultiCell
