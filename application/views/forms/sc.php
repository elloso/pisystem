    ...
    <div class="card" style="max-width: 1500px;">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="sc-data-table" class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url('print-scform'); ?>" target="_blank" title="Print"class="text-primary mx-2"><i class="fa-solid fa-print"></i></a>
                            </td>
                        </tr>
                    </tbody>
                 </table>
